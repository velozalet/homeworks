       ...
       { mode === "booking" && (
        <div className="col-md-6 form-group">
            ...
            <div className="form-check">
                <label className="form-label form-label--email pe-2"><i className="fa fa-envelope"></i></label>
            ...
            <div className="form-check">
                <label className="form-label form-label--phone pe-1"><i className="fa fa-volume-control-phone"></i></label> 
                    <label className="switch">
                        <input 
                            type="checkbox"
                            id="contactByPhone"
